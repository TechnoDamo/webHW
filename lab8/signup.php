...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    try {
        ...
        $sql = "INSERT INTO data (user_id, first_name, last_name, phone, email, birthdate, gender, bio) 
        VALUES (:user_id, :first_name, :lastName, :phone, :email, :birthdate, :gender, :bio)";
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(':user_id', $userId);
